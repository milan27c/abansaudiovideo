...
const CONTENT: Record<TabId, Item[]> = {
  ...
  monitor: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1567958451986-2de427a4a0be?auto=format&fit=crop&w=800&q=80",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1528312635006-8ea0bc49ec63?auto=format&fit=crop&w=800&q=80",
